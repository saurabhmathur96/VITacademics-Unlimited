...
const uri = {
    ...
    applications: 'https://vtopbeta.vit.ac.in/vtop/hostels/lab/permission/view/status',
...
router.post('/apply', (req, res, next) => {
    ...
    req.checkBody('from_time', '`from_time` can be from "08:00 PM" to "04:00 AM".').isIn(supportedTimes);
    req.checkBody('to_time', '`to_time` can be from "09:00 PM" to "05:00 AM".').isIn(supportedTimes);
    ...
    if (supportedTimes.indexOf(req.body.to_time) < supportedTimes.indexOf(req.body.from_time)) {
